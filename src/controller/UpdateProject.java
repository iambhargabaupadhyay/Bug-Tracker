	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String ProjectId=request.getParameter("ProjectId");
		 ...
		 ProjectDao projectdao=new ProjectDao();
			String projectupdated = ProjectDao.updateProject(project);
			if(projectupdated.equals("SUCCESS"))   
			{
				response.sendRedirect("./UpdateProject.jsp?msg=Successfully updated");
			}
			else   
			{
			request.setAttribute("errMessage", projectupdated);
